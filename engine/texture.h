...
class checker_texture: public texture {
    ...
    color value(double u,double v,const point3& p)const override{
        ...
        bool isEven=(xInteger+yInterger+zInteger)%2==0;
...
color value (double u,double v,const point3& p)const override{
    ...
    // return color(1,1,1)* noise.turb(p,7);  straight up  noise directly into the render
    return color(0.5,0.5,0.5)* (1+std::sin(scale*p.z()+10*noise.turb(p,7)));  //hello world solid textures
